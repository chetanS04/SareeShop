                    ...
                    <div className="border border-gray-300 rounded-xl p-3 md:p-6 bg-white flex flex-col gap-4 md:gap-6 shadow-sm">
                        ...
                        <div className="p-4 rounded-xl bg-gray-50 border border-gray-200 space-y-4">
                            ...
                            <div>
                                ...
                                />
                                <p className="text-xs text-red-500 mt-1">{(errors as any).hsn?.message}</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <div>
                                    ...
                                    />
                                    <p className="text-xs text-red-500 mt-1">{(errors as any).cgst?.message}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full py-2 px-3 rounded-lg bg-white border border-gray-300 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400/20 focus:border-[#007FFF] transition text-sm"
                                    />
                                    <p className="text-xs text-red-500 mt-1">{(errors as any).sgst?.message}</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full py-2 px-3 rounded-lg bg-white border border-gray-300 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-400/20 focus:border-[#007FFF] transition text-sm"
                                    />
                                    <p className="text-xs text-red-500 mt-1">{(errors as any).igst?.message}</p>
                                </div>
                            </div>
                        </div>
                        {/* Product Details */}
