                                    ...
                                    >
                                        <div className="pt-0.5">
                                            <input
                                                ...
                                                className="w-4 h-4 text-blue-600 focus:ring-blue-500 border-slate-300 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                                            />
                                        </div>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex flex-wrap items-center justify-between gap-2">
                                                <div className="flex items-center gap-2">
                                                    <span className={`font-bold text-base ${isCodDisabled ? 'text-slate-500 line-through' : 'text-slate-900'}`}>
                                                        Cash on Delivery / Pay on Delivery
                                                    </span>
                                                    {isCodDisabled ? (
                                                        <span className="px-2 py-0.5 bg-rose-50 border border-rose-200 text-rose-700 text-[10px] font-bold rounded uppercase">
                                                            Unavailable for Cart Items
                                                        </span>
                                                    ) : (
                                            ...
                                            <p className="text-xs text-slate-500 mt-1">
                                                {isCodDisabled
                                                    ? "Cash on Delivery is unavailable because one or more items in your cart do not support COD. Please use online payment to complete your order."
                                            ...
                                            {isCodDisabled && (
                                                <div className="mt-3 p-2.5 bg-rose-50 border border-rose-200 rounded-xl text-xs text-rose-800 flex items-start gap-2">
                                                    ...
                                                    <div>
                                                        <span className="font-bold">Non-COD items in your cart:</span>
                                            ...
                                            <div key={item.id} className="p-4 flex flex-col sm:flex-row items-center gap-4">
                                                ...
                                                <div className="flex-1 text-center sm:text-left min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mt-2">
                                                        ...
                                                        {/* Shipping badge */}
                                                        {(Number((item.variant as any)?.shipping_charges ?? (item.variant as any)?.shippingCharges ?? 0) > 0) ? (
                                                            <span className="text-xs font-medium text-slate-700 bg-slate-100 border border-slate-200 px-2 py-0.5 rounded">
                                                                + ₹{Number((item.variant as any)?.shipping_charges ?? (item.variant as any)?.shippingCharges) * item.quantity} Delivery
                                                            </span>
                                                        ) : (
                        ...
                        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-sm space-y-5">
                            ...
                            <div className="space-y-2.5 text-xs text-slate-600 border-t border-slate-100 pt-4">
                                <div className="flex justify-between">
                                    <span>Items Base Price ({count} {count === 1 ? 'item' : 'items'})</span>
