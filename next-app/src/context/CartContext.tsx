            ...
            return {
              ...
              variant: matchingVar
                ? {
                    ...
                    baseSp: matchingVar.baseSp ?? matchingVar.bp ?? (item.variant as any)?.baseSp,
                    is_cod_allowed: matchingVar.is_cod_allowed ?? matchingVar.isCodAllowed ?? (item.variant as any)?.is_cod_allowed ?? true,
                    isCodAllowed: matchingVar.is_cod_allowed ?? matchingVar.isCodAllowed ?? (item.variant as any)?.isCodAllowed ?? true,
                    is_returnable: matchingVar.is_returnable ?? matchingVar.isReturnable ?? (item.variant as any)?.is_returnable ?? true,
                    isReturnable: matchingVar.is_returnable ?? matchingVar.isReturnable ?? (item.variant as any)?.isReturnable ?? true,
                    return_window_days: matchingVar.return_window_days ?? matchingVar.returnWindowDays ?? (item.variant as any)?.return_window_days ?? 7,
                    returnWindowDays: matchingVar.return_window_days ?? matchingVar.returnWindowDays ?? (item.variant as any)?.returnWindowDays ?? 7,
                    shipping_charges: matchingVar.shipping_charges ?? matchingVar.shippingCharges ?? (item.variant as any)?.shipping_charges ?? 0,
                    shippingCharges: matchingVar.shipping_charges ?? matchingVar.shippingCharges ?? (item.variant as any)?.shippingCharges ?? 0,
