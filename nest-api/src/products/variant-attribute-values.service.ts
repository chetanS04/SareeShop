    ...
    const result = await Promise.all(
      pivotRows.map(async (row) => {
        ...
        return {
          ...
          show_image: val.showImage !== undefined ? Boolean(val.showImage) : (val.show_image !== undefined ? Boolean(val.show_image) : false),
          showImage: val.showImage !== undefined ? Boolean(val.showImage) : (val.show_image !== undefined ? Boolean(val.show_image) : false),
