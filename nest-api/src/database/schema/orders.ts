...
export const orderItems = mysqlTable('order_items', {
  ...
  isCodAllowed: boolean('is_cod_allowed').default(true),
  isReturnable: boolean('is_returnable').default(true),
  returnWindowDays: int('return_window_days').default(7),
  shippingCharge: decimal('shipping_charge', { precision: 10, scale: 2 }).default('0.00'),
  createdAt: timestamp('created_at').defaultNow().notNull(),
  updatedAt: timestamp('updated_at').defaultNow().onUpdateNow().notNull(),
});
