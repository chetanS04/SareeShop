...
export const variants = mysqlTable('variants', {
  ...
  isCodAllowed: boolean('is_cod_allowed').default(true).notNull(),
  isReturnable: boolean('is_returnable').default(true).notNull(),
  returnWindowDays: int('return_window_days').default(7).notNull(),
  shippingCharges: decimal('shipping_charges', { precision: 10, scale: 2 }).default('0.00').notNull(),
  status: boolean('status').default(true).notNull(),
